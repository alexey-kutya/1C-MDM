		...
		Если ЭтоЮрЛицо Тогда
			...
			Для НН = 1 По 9 Цикл
				...
				ИначеЕсли НН = 4 Тогда
					Множитель = 3;
				ИначеЕсли НН = 5 Тогда
					Множитель = 5;
				ИначеЕсли НН = 6 Тогда
					Множитель = 9;
				ИначеЕсли НН = 7 Тогда
					Множитель = 4;
				ИначеЕсли НН = 8 Тогда
					Множитель = 6;
				ИначеЕсли НН = 9 Тогда
					Множитель = 8;
				КонецЕсли;

				Цифра = Число(Сред(ИНН, НН, 1));
		...
		Иначе
			...
			Для НН=1 По 11 Цикл
				...
				ИначеЕсли НН = 9 Тогда
					Множитель11 = 6;
					Множитель12 = 4;
				ИначеЕсли НН = 10 Тогда
					Множитель11 = 8;
					Множитель12 = 6;
				ИначеЕсли НН = 11 Тогда
					Множитель11 = 0;
					Множитель12 = 8;
				КонецЕсли;
...
//
// Параметры:
//  ИНН          - Строка - Проверяемый код ИНН.
//  ЭтоЮрЛицо    - Булево - Определяет признак юридического лица.
//
// Возвращаемое значение:
//  Истина       - ИНН соответствует требованиям;
//  Ложь         - ИНН не соответствует требованиям.
//
Функция ИННСоответствуетКонтрЧислу(Знач ИНН, ЭтоЮрЛицо) Экспорт
...
//  Ложь         - КПП не соответствует требованиям.
//
Функция КППСоответствуетКонтрЧислу(Знач КПП) Экспорт
