...
// Возвращает новый БИК банка, если он изменился.
//
// Параметры:
//  Ссылка - СправочникСсылка.КлассификаторБанковРФ - банк, для которого проверяется изменение БИК.
//
// Возвращаемое значение:
//  Структура - новые сведения о банке:
//   Ссылка - СправочникСсылка.КлассификаторБанковРФ - элемент справочника с новыми сведениями.
//   БИК - Строка - новый БИК банка.
Функция НовыеРеквизитыБанка(Ссылка) Экспорт
	
	НаименованиеБанка = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Ссылка, "Наименование");
	...
	Если Выборка.Следующий() Тогда
		Возврат Новый Структура("Ссылка, БИК", Выборка.Ссылка, Выборка.БИК);
	КонецЕсли;
...
Процедура ПриОпределенииНазначенияРолей(НазначениеРолей) Экспорт
	...
	НазначениеРолей.ТолькоДляПользователейСистемы.Добавить(
		Метаданные.Роли.нсиДобавлениеИзменениеБанков.Имя);
