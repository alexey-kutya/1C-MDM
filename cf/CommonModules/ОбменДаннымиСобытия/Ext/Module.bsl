...
Процедура ВключитьИспользованиеПланаОбмена(Источник, Отказ) Экспорт
	...
	Если Источник.ЭтоНовый() И ОбменДаннымиПовтИсп.ЭтоУзелРазделенногоОбменаДаннымиБСП(Источник.Ссылка) Тогда //фыв
		
		// Кэш открытых сеансов для МРО стал неактуальным.
		ОбменДаннымиВызовСервера.СброситьКэшМеханизмаРегистрацииОбъектов();                                   //фыв
...
Функция РазделенныеДанные(ОбъектМетаданных)
	...
	Возврат ОбщегоНазначенияПовтИсп.ЭтоРазделенныйОбъектМетаданных(
			ПолноеИмя, ОбщегоНазначенияПовтИсп.РазделительОсновныхДанных())
		Или ОбщегоНазначенияПовтИсп.ЭтоРазделенныйОбъектМетаданных(
			ПолноеИмя, ОбщегоНазначенияПовтИсп.РазделительВспомогательныхДанных());
