...
Процедура ОбновитьСоставЭлементовФормы(ТекстПредупреждения = "")
	...
	нсиУправлениеВидимостьюВидаСправочника();
...
#Область нсиРаботаСУниверсальнымХранилищем

&НаСервере
Процедура нсиУправлениеВидимостьюВидаСправочника()
	...
	Если Объект.ТипЗначения.СодержитТип(Тип("СправочникСсылка.нсиУниверсальныйФункциональныйСправочник")) Тогда 
		ВидСправочника = Перечисления.нсиВидыСправочников.ФункциональныйСправочник;
	ИначеЕсли Объект.ТипЗначения.СодержитТип(Тип("СправочникСсылка.нсиУниверсальныйКлассификатор")) Тогда 
		ВидСправочника = Перечисления.нсиВидыСправочников.Классификатор;
	КонецЕсли;
	
	ИмяЭлементаВидСправочника = "нсиВидСправочника";
	ЭлементВидСправочника = Элементы.Найти(ИмяЭлементаВидСправочника);
	Если Не ВидСправочника = Неопределено Тогда 
		Если ЭлементВидСправочника = Неопределено Тогда 
			ЭлементВидСправочника = Элементы.Вставить(ИмяЭлементаВидСправочника, Тип("ПолеФормы"), Элементы.КарточкаРеквизита, Элементы.ГруппаМногострочность);
			ЭлементВидСправочника.ПутьКДанным = "Объект.нсиВидСправочника";
			ЭлементВидСправочника.Заголовок = "Вид справочника";
			ЭлементВидСправочника.Вид = ВидПоляФормы.ПолеВвода;
		ИначеЕсли ЭлементВидСправочника.Видимость = Ложь Тогда 
			ЭлементВидСправочника.Видимость = Истина;
		КонецЕсли;
		
		Если ЗначениеЗаполнено(Объект.нсиВидСправочника) И Объект.нсиВидСправочника.ВидСправочника <> ВидСправочника Тогда 
			Объект.нсиВидСправочника = Неопределено;
		КонецЕсли;
		
		НовыйПараметр = Новый ПараметрВыбора("Отбор.ВидСправочника", ВидСправочника);
		МассивПараметрыВыбора = Новый Массив();
		МассивПараметрыВыбора.Добавить(НовыйПараметр);
		ЭлементВидСправочника.ПараметрыВыбора = Новый ФиксированныйМассив(МассивПараметрыВыбора);
	ИначеЕсли Не ЭлементВидСправочника = Неопределено Тогда 
		ЭлементВидСправочника.Видимость = Ложь;
	КонецЕсли;
