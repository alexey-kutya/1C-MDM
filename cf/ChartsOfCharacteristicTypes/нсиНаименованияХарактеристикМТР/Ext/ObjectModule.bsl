...
Процедура ПередЗаписью(Отказ) 
	...
	Запрос.Текст = 
		"ВЫБРАТЬ РАЗРЕШЕННЫЕ
		|	нсиНаименованияХарактеристикМТР.Ссылка
		|ИЗ
		|	ПланВидовХарактеристик.нсиНаименованияХарактеристикМТР КАК нсиНаименованияХарактеристикМТР
		|ГДЕ
		|	нсиНаименованияХарактеристикМТР.Наименование = &Наименование
		|	И НЕ нсиНаименованияХарактеристикМТР.Ссылка = &Ссылка";        		
