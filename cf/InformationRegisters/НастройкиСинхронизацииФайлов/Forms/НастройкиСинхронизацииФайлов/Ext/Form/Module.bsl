...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РегламентноеЗадание = НайтиРегламентноеЗадание("СинхронизацияФайлов");
	АвтоматическиСинхронизироватьФайлы = РегламентноеЗадание.Использование;
	СинхронизацияФайловРасписание      = РегламентноеЗадание.Расписание;
...
Процедура АвтоматическиСинхронизироватьФайлыПриИзменении(Элемент)
	...
	ЗаписатьРегламентноеЗадание("СинхронизацияФайлов", АвтоматическиСинхронизироватьФайлы,
		СинхронизацияФайловРасписание);
	Элементы.Расписание.Доступность = АвтоматическиСинхронизироватьФайлы;
	Элементы.НастроитьРасписание.Доступность = АвтоматическиСинхронизироватьФайлы;
...
Процедура НастроитьРасписание(Команда)
	ДиалогРасписания = Новый ДиалогРасписанияРегламентногоЗадания(СинхронизацияФайловРасписание);
...
Процедура НастроитьРасписаниеЗавершение(Расписание, ДополнительныеПараметры) Экспорт
	...
	СинхронизацияФайловРасписание = Расписание;
	АвтоматическиСинхронизироватьФайлы = Истина;
	ЗаписатьРегламентноеЗадание("СинхронизацияФайлов", АвтоматическиСинхронизироватьФайлы, 
		СинхронизацияФайловРасписание);
