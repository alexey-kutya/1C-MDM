...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РегламентноеЗадание = НайтиРегламентноеЗадание("ОчисткаНенужныхФайлов");
	АвтоматическиОчищатьНенужныеФайлы = РегламентноеЗадание.Использование;
	ОчисткаНенужныхФайловРасписание   = РегламентноеЗадание.Расписание;
	Элементы.Расписание.Заголовок     = РегламентноеЗадание.Расписание;
...
Процедура АвтоматическиОчищатьНенужныеФайлыПриИзменении(Элемент)
	ЗаписатьРегламентноеЗадание("ОчисткаНенужныхФайлов", АвтоматическиОчищатьНенужныеФайлы,
		ОчисткаНенужныхФайловРасписание);
	Элементы.Расписание.Доступность = АвтоматическиОчищатьНенужныеФайлы;
	Элементы.НастроитьРасписание.Доступность = АвтоматическиОчищатьНенужныеФайлы;
КонецПроцедуры
...
Процедура НастроитьРасписание(Команда)
	ДиалогРасписания = Новый ДиалогРасписанияРегламентногоЗадания(ОчисткаНенужныхФайловРасписание);
...
Процедура НастроитьРасписаниеЗавершение(Расписание, ДополнительныеПараметры) Экспорт
	...
	ОчисткаНенужныхФайловРасписание = Расписание;
	АвтоматическиОчищатьНенужныеФайлы = Истина;
	ЗаписатьРегламентноеЗадание("ОчисткаНенужныхФайлов", АвтоматическиОчищатьНенужныеФайлы, 
		ОчисткаНенужныхФайловРасписание);
...
&НаСервере
Процедура ЗаписатьРегламентноеЗадание(ИмяПредопределенного, Использование, Расписание)
