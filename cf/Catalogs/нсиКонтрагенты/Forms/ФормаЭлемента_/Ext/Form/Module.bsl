...
//		Элементы.НадписьПроверкаКПП.Видимость 			= Истина;
	...
	//Элементы.GlobalIDОрганизация.Видимость = НЕ Объект.Нерезидент;
...
&НаКлиенте
Процедура УчастникиОбменаВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	Если Поле.Имя = "УчастникиОбменаОбмен" Тогда
