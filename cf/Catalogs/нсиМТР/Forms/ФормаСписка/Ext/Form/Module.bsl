...
////////////////////////////////////////////////////////////////////////////////
// ПОДСИСТЕМА "Классификатор продукции"
...
&НаКлиенте
Процедура ПоискАналоговПоХарактеристикам(Команда)
	ПараметрыКонтр = Новый Структура();
	ПараметрыКонтр.Вставить("ПараметрКласс", Элементы.Список.ТекущаяСтрока);
	ОткрытьФорму("Справочник.нсиМТР.Форма.ФормаПоискаПоХарактеристикам", ПараметрыКонтр, ЭтаФорма);
КонецПроцедуры
