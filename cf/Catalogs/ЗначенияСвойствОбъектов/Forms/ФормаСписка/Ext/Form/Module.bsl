...
Процедура УстановитьЗаголовок()
	...
	Если ЗначениеЗаполнено(Свойство) 
		И ТипЗнч(Свойство) = Тип("ПланВидовХарактеристикСсылка.ДополнительныеРеквизитыИСведения") Тогда
...
Процедура ПриИзмененииСвойства()
	...
	ИначеЕсли ЗначениеЗаполнено(Свойство)
		И НЕ ТипЗнч(Свойство) = Тип("ПланВидовХарактеристикСсылка.ДополнительныеРеквизитыИСведения") Тогда
		ТолькоПросмотр = Ложь;
		ТипЗначения = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Свойство, "ТипЗначения");
