...
//	Кутья	
	Для Каждого ОбщРеквизит Из Метаданные.ОбщиеРеквизиты Цикл 
		...
		Для каждого ЭлементСостава Из ОбщРеквизит.Состав Цикл
			
			Если ЭлементСостава.Метаданные = МетаданныеИсточника
				И ЭлементСостава.Использование = Метаданные.СвойстваОбъектов.ИспользованиеОбщегоРеквизита.Использовать Тогда
				
				ЗагружаемыйРеквизит                        = ТЗ.Добавить();
				ЗагружаемыйРеквизит.ИмяРеквизита           = ОбщРеквизит.Имя;
				ЗагружаемыйРеквизит.ПредставлениеРеквизита = ОбщРеквизит.Представление();
				ЗагружаемыйРеквизит.МожетБытьПолемПоиска   = Не ОбщРеквизит.Индексирование = Метаданные.СвойстваОбъектов.Индексирование.НеИндексировать;
				ЗагружаемыйРеквизит.ОписаниеТипов = ОбщРеквизит.Тип;
				
			КонецЕсли; 
			
		КонецЦикла; 
		
		//Если ОбщРеквизит.Состав.Содержит(МетаданныеИсточника) Тогда 
		//	ЗагружаемыйРеквизит                        = ТЗ.Добавить();
		//	ЗагружаемыйРеквизит.ИмяРеквизита           = ОбщРеквизит.Имя;
		//	ЗагружаемыйРеквизит.ПредставлениеРеквизита = ОбщРеквизит.Представление();
		//	ЗагружаемыйРеквизит.МожетБытьПолемПоиска   = Не ОбщРеквизит.Индексирование = Метаданные.СвойстваОбъектов.Индексирование.НеИндексировать;
