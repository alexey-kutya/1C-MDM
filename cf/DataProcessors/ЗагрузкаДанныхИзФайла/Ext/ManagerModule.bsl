...
//Кутья АА
Процедура ЗаполнитьИнформациюПоКолонке(Реквизит, МетаданныеСправочника, ИнформацияПоКолонкам, Позиция)
...
Процедура ИнформациюПоКолонкамИзРеквизитовСправочника(ПараметрыЗагрузки, ИнформацияПоКолонкам)
	...
	Для каждого Реквизит Из МетаданныеСправочника.Реквизиты Цикл
		...
		//Кутья АА
		ЗаполнитьИнформациюПоКолонке(Реквизит, МетаданныеСправочника, ИнформацияПоКолонкам, Позиция);
	...
	Для каждого Реквизит Из Метаданные.ОбщиеРеквизиты Цикл
		...
		Для каждого ЭлементСостава Из Реквизит.Состав Цикл
			...
			Если ЭлементСостава.Метаданные = МетаданныеСправочника
		...
		//Если Реквизит.Состав.Содержит(МетаданныеСправочника) Тогда 
		//	
		//	ЗаполнитьИнформациюПоКолонке(Реквизит, МетаданныеСправочника, ИнформацияПоКолонкам, Позиция);
		//	
		//	Позиция = Позиция + 1;
